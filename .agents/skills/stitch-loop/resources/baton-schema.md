...
2. **Design System block** (required) — copied from `docs/stitch-design/DESIGN.md` Section 6
...
- [ ] Prompt describes a page NOT already in `docs/stitch-design/SITE.md` sitemap
