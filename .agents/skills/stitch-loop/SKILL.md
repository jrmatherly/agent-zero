...
- A `docs/stitch-design/DESIGN.md` file (generate one using the `design-md` skill if needed)
- A `docs/stitch-design/SITE.md` file documenting the site vision and roadmap
...
[Copy from docs/stitch-design/DESIGN.md Section 6]
...
- The prompt content must include the design system block from `docs/stitch-design/DESIGN.md`
...
| File | Purpose |
|------|---------|
| `docs/stitch-design/SITE.md` | Site vision, **Stitch Project ID**, existing pages (sitemap), roadmap |
| `docs/stitch-design/DESIGN.md` | Required visual style for Stitch prompts |
...
Modify `docs/stitch-design/SITE.md`:
...
1. **Decide the next page**: 
   - Check `docs/stitch-design/SITE.md` Section 5 (Roadmap) for pending items
...
**DESIGN SYSTEM (REQUIRED):**
[Copy the entire design system block from docs/stitch-design/DESIGN.md]
...
├── docs/stitch-design/ # Stitch design system
...
1. **First time setup**: Generate `docs/stitch-design/DESIGN.md` using the `design-md` skill from an existing Stitch screen
...
| Inconsistent styles | Ensure docs/stitch-design/DESIGN.md is up-to-date and copied correctly |
