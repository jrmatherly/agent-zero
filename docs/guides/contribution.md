...
- **Code Style:** Follow the existing code style. Apollos AI generally follows PEP 8 conventions.
...
- The documentation is built using Markdown. We appreciate your contributions even if you don't know Markdown, and look forward to improve Apollos AI for everyone's benefit.
