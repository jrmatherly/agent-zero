...
### Step 2: Check for docs/stitch-design/DESIGN.md

Look for a `docs/stitch-design/DESIGN.md` file in the current project:

**If docs/stitch-design/DESIGN.md exists:**
...
**If docs/stitch-design/DESIGN.md does not exist:**
1. Add this note at the end of the enhanced prompt:

```
---
💡 **Tip:** For consistent designs across multiple screens, create a docs/stitch-design/DESIGN.md 
